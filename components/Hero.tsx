...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-card to-background">
      <div className="section-container text-center py-20">
        ...
        <div className="flex gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-text text-white rounded-lg hover:bg-secondary transition-colors"
          >
